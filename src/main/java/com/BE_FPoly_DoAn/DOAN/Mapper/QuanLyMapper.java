...
public class QuanLyMapper {

    public static QuanLyResponseDTO toResponseDto(QuanLy entity) {
        QuanLyResponseDTO dto = new QuanLyResponseDTO();
        dto.setQuanLyId(entity.getQuanLyId());
    ...
    public static QuanLy toEntity(QuanLyRequestDTO dto) {
    ...
    public static void updateEntity(QuanLy entity, QuanLyRequestDTO dto, boolean updatePassword) {
        NguoiDung nd = entity.getNguoiDung();
        if (nd != null) {
